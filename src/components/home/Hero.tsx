...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[92vh] sm:min-h-screen flex flex-col justify-between px-6 pt-32 pb-12 sm:pt-40 sm:pb-16 overflow-hidden bg-navy-deep text-white border-b border-navy-primary">
      ...
      <div className="absolute inset-0 bg-grid-architectural-dark pointer-events-none opacity-30 z-0" />

      {/* Vignette Gradients */}
      <div className="absolute inset-0 bg-gradient-to-b from-navy-dark/70 via-navy-deep/60 to-navy-deep pointer-events-none z-0" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full my-auto py-6 sm:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 xl:col-span-5 relative mt-6 lg:mt-0">
            {/* Architectural Operating Model Card inspired by Reference Image 4 */}
            <div className="p-6 sm:p-8 rounded-2xl border border-white/15 bg-navy-primary/80 backdrop-blur-xl shadow-2xl relative space-y-6 overflow-hidden">
